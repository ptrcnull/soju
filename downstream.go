	...
	case "WEBPUSH":
		...
		case "VAPIDPUBKEY":
			dc.SendMessage(&irc.Message{
				Prefix:  dc.srv.prefix(),
				Command: "WEBPUSH",
				Params:  []string{"VAPIDPUBKEY", dc.srv.webPush.VAPIDKeys.Public},
			})
		case "REGISTER":
...
func (dc *downstreamConn) findWebPushSubscription(ctx context.Context, endpoint string) (*WebPushSubscription, error) {
